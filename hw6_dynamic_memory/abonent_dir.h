 ...
 *
 * Удаляет запись по имени абонента. Обёртка для #abonent_del.
 * \note Имя абонента для удаления вводится через stdin (консоль).
 ...
 * \param[in] *dir указатель на справочник.
 * \param[in] *the_abonent указатель на абонента.
 * \return
 * - 0 - всё в порядке
