...
#define MIN_MSG_INPUT_HEIGHT \
  3  // Минимальная высота поля (в строках) для ввода текста с учётом рамки
     // сверху. То есть эффективная высота на одну строку меньше.
#define REL_MSG_INPUT_HEIGHT \
  15  // Высота поля для ввода текста в процентах относительно высоты главного
      // окна/терминала
#define REL_HISTORY_WIDTH \
  70  // Ширина окна с историей чата в процентах относительно ширины главного
      // окна/терминала
