...
/*
void debug(WINDOW *left_panel, WINDOW *left_content, WINDOW *right_panel, WINDOW
*right_content, int active_select) { int lp_y, lp_x, lc_y, lc_x, rp_y, rp_x,
rc_y, rc_x;
  ...
  mvprintw(0, 0, "L %dx%d(%dx%d)  R %dx%d(%dx%d) select %03d", lp_y, lp_x, lc_y,
lc_x, rp_y, rp_x, rc_y, rc_x, active_select);
}
*/
