...
int create_panels(WINDOW *stdscr, WINDOW **left_panel, WINDOW **right_panel,
  ...
  *left_panel =
      newwin(t_y - TOPMENU_SIZE - STATUSBAR_SIZE, (t_x / 2), TOPMENU_SIZE, 0);
  if (NULL == *left_panel) {
    fprintf(stderr,
  ...
  *left_content = derwin(*left_panel, t_y - TOPMENU_SIZE - STATUSBAR_SIZE - 2,
                         (t_x / 2) - 2, 1, 1);
  ...
  *right_panel = newwin(t_y - TOPMENU_SIZE - STATUSBAR_SIZE, (t_x / 2),
                        TOPMENU_SIZE, (t_x + 1) / 2);
  if (NULL == *right_panel) {
    fprintf(stderr,
  ...
  *right_content = derwin(*right_panel, t_y - TOPMENU_SIZE - STATUSBAR_SIZE - 2,
                          (t_x / 2) - 2, 1, 1);
